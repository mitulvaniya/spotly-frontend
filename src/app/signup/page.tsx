...
export default function SignUpPage() {
    ...
    const handleGoogleResponse = useCallback(async (response: any) => {
        ...
        try {
            ...
            if (result.success) {
                toast.success("Welcome to SPOTLY!", { description: "Account created with Google successfully." });
                window.location.href = '/';
            } else {
                toast.error("Google sign-up failed", { description: result.message || "Please try again." });
            }
        } catch (error: any) {
                    ...
                    <div className="glass-card p-8 rounded-3xl border border-white/10 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <Button variant="outline" className="w-full gap-2" type="button" onClick={() => toast.info("GitHub login coming soon!")}>
